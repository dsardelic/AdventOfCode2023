...
class Node(Point):
    ...
    def neighbors(self, heat_losses):
        match self.inbound_direction, self.step_count == MAXIMUM_STEPS_BEFORE_TURN:
            case (Direction.UP, True) | (Direction.DOWN, True):
                combinations = ((Direction.LEFT, 1), (Direction.RIGHT, 1))
            case Direction.UP, False:
                combinations = (
            ...
            case (Direction.LEFT, True) | (Direction.RIGHT, True):
